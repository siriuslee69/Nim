...
function nimCopy(dest_p0, src_p1, ti_p2) {
  var result_33557295 = null;
    ...
    case 23:
    case 5:
      if (!(isFatPointer__system_u2843(ti_p2))) {
      result_33557295 = src_p1;
      }
      else {
        result_33557295 = [src_p1[0], src_p1[1]];
      }
    ...
    case 19:
      ...
      result_33557295 = dest_p0;
    
      break;
    case 18:
    case 17:
      if (!((ti_p2.base == null))) {
      result_33557295 = nimCopy(dest_p0, src_p1, ti_p2.base);
      }
      else {
      if ((ti_p2.kind == 17)) {
      result_33557295 = (dest_p0 === null || dest_p0 === undefined) ? {m_type: ti_p2} : dest_p0;
      }
      else {
        result_33557295 = (dest_p0 === null || dest_p0 === undefined) ? {} : dest_p0;
      }
      }
      nimCopyAux(result_33557295, src_p1, ti_p2.node);
      break;
    case 4:
    case 16:
        ...
        if (src_p1 === null) {
          ...
          for (var i = 0; i < src_p1.length; ++i) {
            result_33557295[i] = nimCopy(result_33557295[i], src_p1[i], ti_p2.base);
          }
        }
      }
    ...
    case 28:
            if (src_p1 !== null) {
        result_33557295 = src_p1.slice(0);
      }
...
function chckIndx(i_p0, a_p1, b_p2) {
  var result_33557330 = 0;

  BeforeRet: {
    if (((a_p1 <= i_p0) && (i_p0 <= b_p2))) {
    result_33557330 = i_p0;
    break BeforeRet;
    }
    else {
...
function reprEnum(e_p0, typ_p1) {
  ...
  framePtr = F;
    ...
    var tmp_33557578 = false;
    F.line = 31;
    var item_33557579 = typ_p1.node.sons[e_p0];
    F.line = 32;
    tmp_33557578 = item_33557579 !== undefined;
    if (tmp_33557578) {
    F.line = 34;
    result_33557577 = nimCopy(null, makeNimstrLit(item_33557579.name), NTI33554449);
    }
    else {
      F.line = 36;
      result_33557577 = nimCopy(null, (HEX24__systemZdollars_u8(e_p0)).concat([32,40,105,110,118,97,108,105,100,32,100,97,116,97,33,41]), NTI33554449);
    }
...
function isFatPointer__system_u2843(ti_p0) {
  var result_33557277 = false;

  BeforeRet: {
    result_33557277 = !((ConstSet1[ti_p0.base.kind] != undefined));
    break BeforeRet;
  };
...
function auxWriteStackTrace__system_u2068(f_p0) {
  var result_33556502 = [[]];
    ...
    var tempFrames_33556513 = arrayConstr(64, {Field0: null, Field1: 0, Field2: null}, NTI33555820);
    Label1: {
        Label2: while (true) {
